...
{ int i ;
      ...
      while (k < 4) {
        if (*(*(ARCHvertex + i) + j) <= *(*(ARCHvertex + i) + k)) {
          ...
          while (ii < 3) {
            jj = 0;
            while (jj < 3) {
              *(K + (kk * (3U * 3U) + (ii * 3U + jj))) += Ke[j * 3 + ii][k * 3 + jj];
              jj ++;
            }
            ii ++;
          }
  ...
  while (iter <= timesteps) {
    ...
    while (i < ARCHnodes) {
      j = 0;
      while (j < 3) {
        *(disp + (disptplus * ((unsigned int )ARCHnodes * 3U) + (i * 3U + j))) = 0.0;
        j ++;
      }
      i ++;
    }
    smvp(ARCHnodes, K, ARCHmatrixcol, ARCHmatrixindex, disp + (dispt * ((unsigned int )ARCHnodes * 3U) + (0 * 3U + 0)),
         disp + (disptplus * ((unsigned int )ARCHnodes * 3U) + (0 * 3U + 0)));
    ...
    while (i < ARCHnodes) {
      j = 0;
      while (j < 3) {
        *(disp + (disptplus * ((unsigned int )ARCHnodes * 3U) + (i * 3U + j))) = (*(disp + (disptplus * ((unsigned int )ARCHnodes * 3U) + (i * 3U + j))) * (- 0.0024 * 0.0024) + (((2.0 * *(*(M + i) + j)) * *(disp + (dispt * ((unsigned int )ARCHnodes * 3U) + (i * 3U + j))) - (*(*(M + i) + j) - (0.0024 / 2.0) * *(*(C + i) + j)) * *(disp + (disptminus * ((unsigned int )ARCHnodes * 3U) + (i * 3U + j)))) - (0.0024 * 0.0024) * (((*(*(M23 + i) + j) * tmp___1) / 2.0 + (*(*(C23 + i) + j) * tmp___2) / 2.0) + (*(*(V23 + i) + j) * tmp___3) / 2.0))) / (*(*(M + i) + j) + (0.0024 / 2.0) * *(*(C + i) + j));
        *(*(vel + i) + j) = (0.5 / 0.0024) * (*(disp + (disptplus * ((unsigned int )ARCHnodes * 3U) + (i * 3U + j))) - *(disp + (disptminus * ((unsigned int )ARCHnodes * 3U) + (i * 3U + j))));
        j ++;
      }
      i ++;
    }
    if (iter % Step_stride == 0) {
      ...
      if (Src.sourcenode <= ARCHmine) {
        printf((char const   * __restrict  )"%d: %.2e %.2e %.2e\n", *(ARCHglobalnode + Src.sourcenode),
               *(disp + (disptplus * ((unsigned int )ARCHnodes * 3U) + (Src.sourcenode * 3U + 0))),
               *(disp + (disptplus * ((unsigned int )ARCHnodes * 3U) + (Src.sourcenode * 3U + 1))),
               *(disp + (disptplus * ((unsigned int )ARCHnodes * 3U) + (Src.sourcenode * 3U + 2))));
      }
      if (Src.epicenternode <= ARCHmine) {
        printf((char const   * __restrict  )"%d: %.2e %.2e %.2e\n", *(ARCHglobalnode + Src.epicenternode),
               *(disp + (disptplus * ((unsigned int )ARCHnodes * 3U) + (Src.epicenternode * 3U + 0))),
               *(disp + (disptplus * ((unsigned int )ARCHnodes * 3U) + (Src.epicenternode * 3U + 1))),
               *(disp + (disptplus * ((unsigned int )ARCHnodes * 3U) + (Src.epicenternode * 3U + 2))));
      }
      fflush(stdout);
    }
    i = disptminus;
...
{ int i ;
  ...
  while (i < nodes) {
    Anext = *(Aindex + i);
    Alast = *(Aindex + (i + 1));
    sum0 = (*(A + (Anext * (3U * 3U) + (0 * 3U + 0))) * *(v + (i * 3U + 0)) + *(A + (Anext * (3U * 3U) + (0 * 3U + 1))) * *(v + (i * 3U + 1))) + *(A + (Anext * (3U * 3U) + (0 * 3U + 2))) * *(v + (i * 3U + 2));
    sum1 = (*(A + (Anext * (3U * 3U) + (1 * 3U + 0))) * *(v + (i * 3U + 0)) + *(A + (Anext * (3U * 3U) + (1 * 3U + 1))) * *(v + (i * 3U + 1))) + *(A + (Anext * (3U * 3U) + (1 * 3U + 2))) * *(v + (i * 3U + 2));
    sum2 = (*(A + (Anext * (3U * 3U) + (2 * 3U + 0))) * *(v + (i * 3U + 0)) + *(A + (Anext * (3U * 3U) + (2 * 3U + 1))) * *(v + (i * 3U + 1))) + *(A + (Anext * (3U * 3U) + (2 * 3U + 2))) * *(v + (i * 3U + 2));
    Anext ++;
    while (Anext < Alast) {
      col = *(Acol + Anext);
      sum0 += (*(A + (Anext * (3U * 3U) + (0 * 3U + 0))) * *(v + (col * 3U + 0)) + *(A + (Anext * (3U * 3U) + (0 * 3U + 1))) * *(v + (col * 3U + 1))) + *(A + (Anext * (3U * 3U) + (0 * 3U + 2))) * *(v + (col * 3U + 2));
      sum1 += (*(A + (Anext * (3U * 3U) + (1 * 3U + 0))) * *(v + (col * 3U + 0)) + *(A + (Anext * (3U * 3U) + (1 * 3U + 1))) * *(v + (col * 3U + 1))) + *(A + (Anext * (3U * 3U) + (1 * 3U + 2))) * *(v + (col * 3U + 2));
      sum2 += (*(A + (Anext * (3U * 3U) + (2 * 3U + 0))) * *(v + (col * 3U + 0)) + *(A + (Anext * (3U * 3U) + (2 * 3U + 1))) * *(v + (col * 3U + 1))) + *(A + (Anext * (3U * 3U) + (2 * 3U + 2))) * *(v + (col * 3U + 2));
      *(w + (col * 3U + 0)) += (*(A + (Anext * (3U * 3U) + (0 * 3U + 0))) * *(v + (i * 3U + 0)) + *(A + (Anext * (3U * 3U) + (1 * 3U + 0))) * *(v + (i * 3U + 1))) + *(A + (Anext * (3U * 3U) + (2 * 3U + 0))) * *(v + (i * 3U + 2));
      *(w + (col * 3U + 1)) += (*(A + (Anext * (3U * 3U) + (0 * 3U + 1))) * *(v + (i * 3U + 0)) + *(A + (Anext * (3U * 3U) + (1 * 3U + 1))) * *(v + (i * 3U + 1))) + *(A + (Anext * (3U * 3U) + (2 * 3U + 1))) * *(v + (i * 3U + 2));
      *(w + (col * 3U + 2)) += (*(A + (Anext * (3U * 3U) + (0 * 3U + 2))) * *(v + (i * 3U + 0)) + *(A + (Anext * (3U * 3U) + (1 * 3U + 2))) * *(v + (i * 3U + 1))) + *(A + (Anext * (3U * 3U) + (2 * 3U + 2))) * *(v + (i * 3U + 2));
      Anext ++;
    }
    *(w + (i * 3U + 0)) += sum0;
    *(w + (i * 3U + 1)) += sum1;
...
{ int i ;
  ...
  tmp___14 = malloc((3U * ((unsigned int )ARCHnodes * 3U)) * sizeof(double ));
  ...
  i = 0;
  while (i < 3) {
    if (disp + (i * ((unsigned int )ARCHnodes * 3U) + (0 * 3U + 0)) == (unsigned int )((double **)((void *)0))) {
    ...
    j = 0;
    while (j < ARCHnodes) {
      if (disp + (i * ((unsigned int )ARCHnodes * 3U) + (j * 3U + 0)) == (unsigned int )((double *)((void *)0))) {
  ...
  tmp___17 = malloc(((unsigned int )ARCHmatrixlen * (3U * 3U)) * sizeof(double ));
  K = (double *)tmp___17;
  if (0) {
  ...
  i = 0;
  while (i < ARCHmatrixlen) {
    if (K + (i * (3U * 3U) + (0 * 3U + 0)) == (unsigned int )((double **)((void *)0))) {
    ...
    j = 0;
    while (j < 3) {
      if (K + (i * (3U * 3U) + (j * 3U + 0)) == (unsigned int )((double *)((void *)0))) {
  ...
  while (i < ARCHnodes) {
    *(nodekind + i) = 0;
    ...
    while (j < 3) {
      ...
      *(*(C23 + i) + j) = 0.0;
      *(*(V23 + i) + j) = 0.0;
      *(disp + (0 * ((unsigned int )ARCHnodes * 3U) + (i * 3U + j))) = 0.0;
      *(disp + (1 * ((unsigned int )ARCHnodes * 3U) + (i * 3U + j))) = 0.0;
      *(disp + (2 * ((unsigned int )ARCHnodes * 3U) + (i * 3U + j))) = 0.0;
      j ++;
    }
    i ++;
  }
